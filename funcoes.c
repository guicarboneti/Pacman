...
void reinicia_fantasma (unsigned char tabuleiro[LINHAS][COLUNAS], struct pac *ptr_pac, struct lista_dupla_ligada *L)
{
    ...
    {
        struct fantasma *fant = achaFantasma(L, i);
        if ((ptr_pac->x-1 == fant->x-1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x-1 == fant->x  && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x-1 == fant->x+1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x == fant->x-1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x == fant->x && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x == fant->x+1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x+1 == fant->x-1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x+1 == fant->x && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x+1 == fant->x+1 && ptr_pac->y-2 == fant->y+1) || (ptr_pac->x-1 == fant->x-1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x-1 == fant->x && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x-1 == fant->x+1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x == fant->x-1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x == fant->x && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x == fant->x+1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x+1 == fant->x-1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x+1 == fant->x && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x+1 == fant->x+1 && ptr_pac->y+2 == fant->y-1) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y-1 == fant->y-1) || (ptr_pac->x-2 == ptr_pac->y-1 && fant->x+1 == fant->y) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y-1 == fant->y+1) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y == fant->y-1) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y == fant->y) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y == fant->y+1) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y+1 == fant->y-1) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y+1 == fant->y) || (ptr_pac->x-2 == fant->x+1 && ptr_pac->y+1 == fant->y+1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y-1 == fant->y-1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y-1 == fant->y) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y-1 == fant->y+1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y == fant->y-1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y == fant->y) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y == fant->y+1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y+1 == fant->y-1) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y+1 == fant->y) || (ptr_pac->x+2 == fant->x-1 && ptr_pac->y+1 == fant->y+1))
        {
...
void movimentacao(unsigned char tabuleiro[LINHAS][COLUNAS], struct pac *ptr_pac, int fase, int *ptr_tecla, struct lista_dupla_ligada *L, struct moeda moedas[152], struct sistema *ptr_sistema, int cont)
{
    ...
    {
        cont = cont + 1;
        mvprintw(15, 120, "CONT = %d    ", cont);
        if (cont > 9)
        {
            ptr_pac->energizado = 0;
            ptr_sistema->pts_adicional = 0;
            cont = 0;
        }
    }
            ...
            while (!parede(tabuleiro, ptr_pac->x, ptr_pac->y, ptr_pac->direcao) && !encerrou(tabuleiro) && !(colisao(tabuleiro, ptr_pac) && ptr_pac->energizado == 0)) /* verifica se a próxima posição é a parede */
            {
                ...
                else
                {
                    ...
                    if (colisao(tabuleiro, ptr_pac) && ptr_pac->energizado == 1)
                    {
                        ...
                        ptr_sistema->pts_adicional = ptr_sistema->pts_adicional + 200;
                    }

                    ptr_sistema->pontos = ptr_sistema->pontos + ptr_sistema->pts_adicional;
